...
$user_obj = new User;
$user = $user_obj->getUser($_SESSION['id']);//retrieving logged in id user information
      ...
      <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
        <div class="row justify-content-center mb-3">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="username" id="username" class="form-control fw-bold" maxlength="15" value="<?= $user['username'] ?>">
          </div>
          <div class="text-end">
